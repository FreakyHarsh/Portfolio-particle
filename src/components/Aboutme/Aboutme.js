        ...
        <Row>
          <Col sm={12} md={4} className='d-flex flex-column align-items-center'>
            ...
            <p className='aboutme-para'>
              I can design websites in figma and can covert any design to actual working website
          ...
          <Col sm={12} md={4} className='d-flex flex-column align-items-center'>
            <h3>Code</h3>
            <div
              className='d-flex w-100 px-4 justify-content-between px-2 flex-wrap'
              style={{ fontSize: '4rem' }}
            >
            ...
            <p className='aboutme-para'>
              I am a Full-Stack ReactJS developer who believes in writing tidy and elegant code in
              line with the DRY principle. I can also use Angular, React native and Flutter to build
          ...
          <Col sm={12} md={4} className='d-flex flex-column align-items-center'>
            ...
            <p className='aboutme-para'>
              I use tools like git, github for versioning and collaboration along with powerful
              editors like VSCode, Sublime & Vim.
            </p>
          </Col>
        </Row>
      </Container>
